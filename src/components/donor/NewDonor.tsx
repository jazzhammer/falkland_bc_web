  ...
  return (
    <div className="fbc-form">
      ...
      <Form
        ...
        wrapperCol={{ span: 16 }}
        style={{ maxWidth: 600 }}
        initialValues={{ country: Country.CAN, type: DonorType.INDIVIDUAL }}
        onFinish={onFinish}
      ...
      >
        ...
        >
          <Radio.Group onChange={selectDonorType} value={donorType} className="fbc-radio-row">
            <Radio value={DonorType.INDIVIDUAL} style={{color: "white"}}>individual</Radio>
        ...
        {donorType == DonorType.INDIVIDUAL &&
          <div>
            <Form.Item
              ...
              name="last_name"
              rules={[{required: true, message: 'if donor is an individual, provide a last name'}]}
            >
            ...
            <Form.Item
              ...
              name="first_name"
              rules={[{required: true, message: 'if donor is an individual, provide a first name'}]}
            >
